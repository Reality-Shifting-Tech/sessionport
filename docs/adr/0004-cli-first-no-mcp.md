...
sess competes in a fast-moving space where the distribution story matters as
...
v0.1 ships a single CLI (`sess list/export/import/score`) backed by a plain
...
v0.1. Harder: agents that speak MCP cannot call sess directly until v0.2;
